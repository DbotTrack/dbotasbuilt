...
export default function Hero() {
  const { bookProject, openEstimator, logIn, scrollToSection } = useApp()
  return (
      ...
      <div className="container-site grid grid-cols-1 min-[601px]:grid-cols-[1.05fr_0.95fr] gap-9 min-[601px]:gap-12 items-center">
        <div>
          <span className="eyebrow inline-flex items-center gap-2 mb-5">
            <span className="w-[7px] h-[7px] rounded-full bg-orange" /> LiDAR 3D scanning · Chennai
          </span>
        ...
        <div className="relative aspect-[1/0.92]">
          <div className="absolute inset-0 border border-grey-1 rounded-xl shadow-xl overflow-hidden bg-gradient-to-br from-white to-[#faf8f6]">
            <PointCloudRoom seed={7} />
          </div>
